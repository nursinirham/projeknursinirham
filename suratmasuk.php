<?php 
 ...
 <!DOCTYPE html>
  ...
  <div class="row" style="margin-left: 300px;">
    ...
    <li>
      <div class="collapsible-header grey-text text-darken-2" style="letter-spacing:1px;"><i class="material-icons">search</i>Cari Surat Masuk</div>
    ...
    <li>
      <div class="collapsible-header grey-text text-darken-2" style="letter-spacing:1px;"><i class="material-icons">add</i>Tambah Surat Masuk</div>
      <div class="collapsible-body white">
      <div class="card z-depth-0" style="margin-top:-3%;">
        <div class="card-content">
          <div class="container">
           <h3 class="grey-text text-darken-2 center" style="font-weight: 600;letter-spacing: -2px;">Tambah Surat Masuk</h3>
         ...
         <!-- <h3 class="grey-text text-darken-2 center" style="font-weight: 600;letter-spacing: -2px;">Kelola Surat Masuk</h3> -->
           <table id="kelolasuratmasuk" class="table">
            ...
            if (empty($_GET['tanggalawal'])) {
              $sqlex = "SELECT * FROM tbl_surat WHERE status_surat = 'masuk' ORDER BY waktu_datang DESC";
            } else {
              $sqlex = "SELECT * FROM tbl_surat WHERE  status_surat = 'masuk' AND waktu_datang between '$_GET[tanggalawal]' AND '$_GET[tanggalakhir]' ORDER BY waktu_datang DESC";
            }
              ...
              while ($anggota = mysql_fetch_array($sql)) {
                ...
                <td>
                    ...
                    <a href="#disposisikan<?php echo $anggota['kd_surat'] ?>" class="modal-trigger btn-floating deep-orange secondary-content accent waves-effect waves-light hide-on-med-and-down tooltipped" data-position="top" data-delay="50" data-tooltip="Disposisikan" style="margin-right: 3%;"><i class="material-icons">forward</i></a>
